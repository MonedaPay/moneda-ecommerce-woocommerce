...
class OrderInfoHandler extends AbstractRestEndpoint {
	 ...
	 * @param  Gateway $gateway  The gateway instance.
	 *
	 * @return OrderInfoResponseInterface The order data.
	 * @throws ConfigurationException
	 */
	private static function get_order_data( Gateway $gateway ): OrderInfoResponseInterface {
		...
		return $client->createOrderInfoRequest( $response );
	}
}
